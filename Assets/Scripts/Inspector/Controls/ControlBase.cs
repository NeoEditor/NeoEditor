...
namespace NeoEditor.Inspector.Controls
{
    public class ControlBase : MonoBehaviour
    {
		...
		public virtual List<Selectable> selectables { get => null; set { } }
		public virtual string text { get => null; set { } }
		...
		public virtual void EnumSetup(string enumTypeString, List<string> enumVals, bool localize = true, List<string> customLabels = null)
		{
		}
		...
		public void ToggleOthersEnabled()
		{
			...
			{
				if (!(property3.info.name == "specialArtistType") && !(property3.info.name == "artistPermission"))
				{
