    ...
    public class Control_Bool : ControlBase
    {
		...
		private void SetValue(bool on)
		{
			...
			using (new SaveStateScope(editor, false, true, false))
			{
				...
				{
					PropertyControl_FilterProperties propertyControl_FilterProperties = inspectorPanel.properties["filterProperties"].control as PropertyControl_FilterProperties;
